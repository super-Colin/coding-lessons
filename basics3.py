...
def printTwoInputs(param1, anotherParam):
    print(param1)
    print(anotherParam)
...
print('returningFunction is returning: ' + str(returningFunction()) + ' to the print() command')
...
if 15 > 17:
    print('(12 + 3) > 17 is truthy')
else:
    print('(12 + 3) > 17 is NOT truthy, so else was fired')

print('\n')

    # We can also use expressions, variables and even functions in out conditional statement
